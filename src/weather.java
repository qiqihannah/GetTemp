...
//            int count;
//            System.out.println(nl.item(8).getFirstChild().getNodeValue());
//            for (count = 0; count < nl.getLength(); count++) {
...
//            }
            is.close();
            return nl.item(8).getFirstChild().getNodeValue();
//            return sb.toString();
        } catch (Exception e) {
            e.printStackTrace();
            return null;
...
//        String weatherInfo = getWeather("2008");
